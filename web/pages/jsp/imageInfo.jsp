...
<form id="info" name="info" action="<%=path %>/adminUser?method=updateImg" method="post" enctype="multipart/form-data">    
       ...
       <table width="100%" align="center" cellpadding="0" cellspacing="0" class="editbody">
        <tr class="editbody">
          <td align="center" height="30">
            <input type="button" id="saveBtn" Class="btnstyle" value="上传头像" onclick="submitForm()"/> 
          </td>
        </tr>
      </table>
     </td>
