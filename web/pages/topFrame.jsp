...
<%
	...
	String truename = (String)session.getAttribute("logintruename");
%>
...
<script type="text/javascript">
	$(function(){
		$("#resetReg").click(function(){
			var btn = document.getElementById('resetReg');
  ...
  <tr>
    ...
    <td width="712" align="left" valign="middle"><table width="59%"  >
      <tr>
        ...
        <td width="5%" align="right"><img src="../image/index.gif" width="17" height="16" border="0" class="buttonCss"></a></td>
        <td width="14%"><a href="" id="resetReg">重新登录</a></td>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>欢迎</strong>：<a href="jsp/modifyInfo.jsp" target="bottomFrame">${userBean.truename}</a>
